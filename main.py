...
import numpy as np
from modules.utils import analyze_results, plot_comparative_history, plot_grid_generation, plot_history, save_history_to_csv
...
if __name__ == '__main__':
    ...
    analyze_results("csv_human_factor", "final_results")